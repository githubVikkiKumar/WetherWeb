@echo off
title Weather App - Real-time Only (No Demo Data)
...
echo Starting Weather App with Real-time Data Only (No Demo Data)...
...
echo.
echo ========================================
echo Weather App with Real-time Data Only is now running!
echo ========================================
echo.
echo Frontend: http://localhost:4200
echo Backend: http://localhost:3000
echo.
echo Real-time Features (No Demo Data):
echo - Backend API first, then OpenWeatherMap API
echo - Multiple search strategies for better results
echo - Real-time UV Index calculations
echo - Real-time Air Quality calculations
echo - Real weather data from APIs only
echo - No demo/fallback data
echo - Auto-refresh every 2 minutes
echo.
echo If APIs fail, app will show "Weather data unavailable"
echo instead of demo data.
echo.
